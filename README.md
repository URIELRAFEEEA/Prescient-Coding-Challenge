...
I developed a dynamic tactical asset-allocation strategy that combines market momentum, short-term reversal and macroeconomic trends.
...
The strategy uses a 60-day lookback and calculates risk-adjusted momentum using:
